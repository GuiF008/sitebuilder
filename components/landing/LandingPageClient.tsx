  ...
  return (
    <div className="min-h-screen bg-white w-full">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 w-full">
        {/* Hero : affiché uniquement quand pas en mode onboarding */}
        {currentStep === 0 && (
        ...
        {/* Progress + formulaire onboarding */}
        {currentStep > 0 && (
          <>
            <div className="text-center mb-6">
              <p className="text-ovh-gray-600">Créez votre site en 4 étapes</p>
            </div>
            <div className="mb-10">
        ...
        {/* Step content */}
        {currentStep > 0 && (
          <div ref={stepContentRef} className="bg-white rounded-ovh-lg shadow-sm border border-ovh-gray-200 p-8 max-w-4xl mx-auto">
            {/* Step 1: Identity */}
            {currentStep === 1 && (
