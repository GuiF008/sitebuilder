                ...
                >
                  ...
                  {type === 'audio' && (
                    <>
                      ...
                      <span className="text-sm text-ovh-gray-700 truncate">{m.originalName ?? m.filename}</span>
                    </>
                  )}
                </button>
              ))}
                ...
                >
                  ...
                  {mediaFilter === 'audio' && (
                    <div className="w-full h-full flex flex-col items-center justify-center bg-ovh-gray-50 p-2">
                      ...
                      <span className="text-[10px] text-ovh-gray-500 truncate w-full text-center">{m.originalName ?? m.filename}</span>
                    </div>
                  )}
                </button>
              ))}
